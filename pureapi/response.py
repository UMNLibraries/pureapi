...
def change(record: MutableMapping) -> Dict:
    ...
    d = Dict(record)
    return d
change_522 = change_521 = change_520 = change
'''``change_522()``, ``change_521()``, and ``change_520()`` are aliases of ``change()``.'''
...
def external_organisation(record: MutableMapping) -> Dict:
    ...
    return d
external_organisation_522 = external_organisation_521 = external_organisation_520 = external_organisation
'''``external_organisation_522``, ``external_organisation_521``, and ``external_organisation_520``  are
...
def external_person(record: MutableMapping) -> Dict:
    ...
    return d
external_person_522 = external_person_521 = external_person_520 = external_person
'''``external_person_522``, ``external_person_521``,  and ``external_person_520`` are
...
def organisational_unit(record: MutableMapping) -> Dict:
    ...
    return d
organisational_unit_522 = organisational_unit_521 = organisational_unit_520 = organisational_unit
'''``organisational_unit_522``, ``organisational_unit_521``, and ``organisational_unit_520``
...
def person(record: MutableMapping) -> Dict:
    ...
    return d
person_522 = person_521 = person_520 = person_519 = person_518 = person
'''``person_522``, ``person_521``, and ``person_520`` are aliases of ``person()``.'''
...
def research_output(record: MutableMapping) -> Dict:
    ...
    return d
research_output_522 = research_output_521 = research_output_520 = research_output
'''``research_output_522``, ``research_output_521``, and ``research_output_520`` are aliases of
``research_output()``.'''
